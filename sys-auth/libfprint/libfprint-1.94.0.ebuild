...
DESCRIPTION="Library to add support for consumer fingerprint readers (elanmoc2 branch)"
HOMEPAGE="
	https://fprint.freedesktop.org/
	https://gitlab.freedesktop.org/libfprint/libfprint
	https://gitlab.freedesktop.org/depau/libfprint/-/tree/elanmoc2?ref_type=heads
"
# SRC_URI="https://gitlab.freedesktop.org/${PN}/${PN}/-/archive/v${PV}/${MY_P}.tar.bz2 -> ${P}.tar.bz2"
EGIT_REPO_URI="https://gitlab.freedesktop.org/depau/libfprint.git"
EGIT_BRANCH="elanmoc2"
