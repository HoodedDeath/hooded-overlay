...
# a dependency.
# Not entirely sure of that USE for pipewire. This seemingly depends on the pulseaudio compat for pipewire, and I'm purely guessing that comes with the sound-server flag
